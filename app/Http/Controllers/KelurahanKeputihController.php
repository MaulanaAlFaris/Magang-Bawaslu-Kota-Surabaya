...
class KelurahanKeputihController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $data=[
            ...
            'peristiwa'=>  $request->peristiwa ?: Kelurahan_Keputih_Form::$defaults['peristiwa'],
            'tempat_kejadian_peristiwa'=>  $request->tempat_kejadian_peristiwa ?: Kelurahan_Keputih_Form::$defaults['tempat_kejadian_peristiwa'],
            'pelaku_peristiwa'=>  $request->pelaku_peristiwa ?: Kelurahan_Keputih_Form::$defaults['pelaku_peristiwa'],
            'alamat_peristiwa'=>  $request->alamat_peristiwa ?: Kelurahan_Keputih_Form::$defaults['alamat_peristiwa'],
            'nama_saksi_1'=>  $request->nama_saksi_1 ?: Kelurahan_Keputih_Form::$defaults['nama_saksi_1'],
            'alamat_saksi_1'=>  $request->alamat_saksi_1 ?: Kelurahan_Keputih_Form::$defaults['alamat_saksi_1'],
            'nama_saksi_2'=>  $request->nama_saksi_2 ?: Kelurahan_Keputih_Form::$defaults['nama_saksi_2'],
            'alamat_saksi_2'=>  $request->alamat_saksi_2 ?: Kelurahan_Keputih_Form::$defaults['alamat_saksi_2'],
            'alat_bukti_1'=>  $request->alat_bukti_1 ?: Kelurahan_Keputih_Form::$defaults['alat_bukti_1'],
            'alat_bukti_2'=>  $request->alat_bukti_2 ?: Kelurahan_Keputih_Form::$defaults['alat_bukti_2'],
            'alat_bukti_3'=>  $request->alat_bukti_3 ?: Kelurahan_Keputih_Form::$defaults['alat_bukti_3'],
            'barang_bukti_1'=>  $request->barang_butki_1 ?: Kelurahan_Keputih_Form::$defaults['barang_bukti_1'],
            'barang_bukti_2'=>  $request->barang_butki_2 ?: Kelurahan_Keputih_Form::$defaults['barang_bukti_2'],
            'barang_bukti_3'=>  $request->barang_butki_3 ?: Kelurahan_Keputih_Form::$defaults['barang_bukti_3'],
            'uraian_singkat_dugaan'=>  $request->uraian_singkat_dugaan ?: Kelurahan_Keputih_Form::$defaults['uraian_singkat_dugaan'],
            'fakta'=>  $request->fakta ?: Kelurahan_Keputih_Form::$defaults['fakta'],
            'analisa'=>  $request->analisa ?: Kelurahan_Keputih_Form::$defaults['analisa'],
            'peserta_pemilu_sengketa'=>  $request->peserta_pemilu_sengketa ?: Kelurahan_Keputih_Form::$defaults['peserta_pemilu_sengketa'],
            'tempat_sengketa'=>  $request->tempat_sengketa ?: Kelurahan_Keputih_Form::$defaults['tempat_sengketa'],
            'waktu_sengketa'=>  $request->waktu_sengketa ?: Kelurahan_Keputih_Form::$defaults['waktu_sengketa'],
            'bentuk_objek'=>  $request->bentuk_objek ?: Kelurahan_Keputih_Form::$defaults['bentuk_objek'],
            'identitas_objek'=> $request->identitas_objek ?: Kelurahan_Keputih_Form::$defaults['identitas_objek'],
            'hari_objek'=>  $request->hari_objek ?: Kelurahan_Keputih_Form::$defaults['hari_objek'],
            'kerugian_objek'=>  $request->kerugian_objek ?: Kelurahan_Keputih_Form::$defaults['kerugian_objek'],
            'uraian_objek'=>  $request->uraian_objek ?: Kelurahan_Keputih_Form::$defaults['uraian_objek'],
    ...
    public function show(string $id)
    {
        ...
        return view('content.kelurahan.Kecamatan_13_Sukolilo.Kelurahan_Keputih.show')->with('data', $data);
    }
    ...
    public function pdf(string $id, Repository $config, Filesystem $files, Factory $view, Request $request)
    {
        ...
        $pdf = Pdf::loadView('content.kelurahan.Kecamatan_13_Sukolilo.Kelurahan_Keputih.pdf', ['data' => $data]);

        if ($request->input('download')) {
            return $pdf->download("KelurahanKeputih_{$id}.pdf");
        } else {
            return $pdf->stream();
        }
    }

    public function searchKelKeputih(Request $request)
    {
        $searchKeyword = $request->input('keyword');

    if ($searchKeyword) {
        $data = Kelurahan_Keputih_Form::where('nama_pelaksana', 'LIKE', "%$searchKeyword%")
        ...
        if ($data->isEmpty()) {
            return view('content.kelurahan.Kecamatan_13_Sukolilo.Kelurahan_Keputih.index')
                ->with('data', $data)
