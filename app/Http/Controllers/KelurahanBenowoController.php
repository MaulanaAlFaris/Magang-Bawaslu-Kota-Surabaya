...
class KelurahanBenowoController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $data=[
            ...
            'peristiwa'=>  $request->peristiwa ?: Kelurahan_Benowo_Form::$defaults['peristiwa'],
            'tempat_kejadian_peristiwa'=>  $request->tempat_kejadian_peristiwa ?: Kelurahan_Benowo_Form::$defaults['tempat_kejadian_peristiwa'],
            'pelaku_peristiwa'=>  $request->pelaku_peristiwa ?: Kelurahan_Benowo_Form::$defaults['pelaku_peristiwa'],
            'alamat_peristiwa'=>  $request->alamat_peristiwa ?: Kelurahan_Benowo_Form::$defaults['alamat_peristiwa'],
            'nama_saksi_1'=>  $request->nama_saksi_1 ?: Kelurahan_Benowo_Form::$defaults['nama_saksi_1'],
            'alamat_saksi_1'=>  $request->alamat_saksi_1 ?: Kelurahan_Benowo_Form::$defaults['alamat_saksi_1'],
            'nama_saksi_2'=>  $request->nama_saksi_2 ?: Kelurahan_Benowo_Form::$defaults['nama_saksi_2'],
            'alamat_saksi_2'=>  $request->alamat_saksi_2 ?: Kelurahan_Benowo_Form::$defaults['alamat_saksi_2'],
            'alat_bukti_1'=>  $request->alat_bukti_1 ?: Kelurahan_Benowo_Form::$defaults['alat_bukti_1'],
            'alat_bukti_2'=>  $request->alat_bukti_2 ?: Kelurahan_Benowo_Form::$defaults['alat_bukti_2'],
            'alat_bukti_3'=>  $request->alat_bukti_3 ?: Kelurahan_Benowo_Form::$defaults['alat_bukti_3'],
            'barang_bukti_1'=>  $request->barang_butki_1 ?: Kelurahan_Benowo_Form::$defaults['barang_bukti_1'],
            'barang_bukti_2'=>  $request->barang_butki_2 ?: Kelurahan_Benowo_Form::$defaults['barang_bukti_2'],
            'barang_bukti_3'=>  $request->barang_butki_3 ?: Kelurahan_Benowo_Form::$defaults['barang_bukti_3'],
            'uraian_singkat_dugaan'=>  $request->uraian_singkat_dugaan ?: Kelurahan_Benowo_Form::$defaults['uraian_singkat_dugaan'],
            'fakta'=>  $request->fakta ?: Kelurahan_Benowo_Form::$defaults['fakta'],
            'analisa'=>  $request->analisa ?: Kelurahan_Benowo_Form::$defaults['analisa'],
            'peserta_pemilu_sengketa'=>  $request->peserta_pemilu_sengketa ?: Kelurahan_Benowo_Form::$defaults['peserta_pemilu_sengketa'],
            'tempat_sengketa'=>  $request->tempat_sengketa ?: Kelurahan_Benowo_Form::$defaults['tempat_sengketa'],
            'waktu_sengketa'=>  $request->waktu_sengketa ?: Kelurahan_Benowo_Form::$defaults['waktu_sengketa'],
            'bentuk_objek'=>  $request->bentuk_objek ?: Kelurahan_Benowo_Form::$defaults['bentuk_objek'],
            'identitas_objek'=> $request->identitas_objek ?: Kelurahan_Benowo_Form::$defaults['identitas_objek'],
            'hari_objek'=>  $request->hari_objek ?: Kelurahan_Benowo_Form::$defaults['hari_objek'],
            'kerugian_objek'=>  $request->kerugian_objek ?: Kelurahan_Benowo_Form::$defaults['kerugian_objek'],
            'uraian_objek'=>  $request->uraian_objek ?: Kelurahan_Benowo_Form::$defaults['uraian_objek'],
    ...
    public function show(string $id)
    {
        ...
        return view('content.kelurahan.Kecamatan_28_Pakal.Kelurahan_Benowo.show')->with('data', $data);
    }
    ...
    public function pdf(string $id, Repository $config, Filesystem $files, Factory $view, Request $request)
    {
        ...
        $pdf = Pdf::loadView('content.kelurahan.Kecamatan_28_Pakal.Kelurahan_Benowo.pdf', ['data' => $data]);

        if ($request->input('download')) {
            return $pdf->download("KelurahanBenowo_{$id}.pdf");
        } else {
            return $pdf->stream();
        }
    }

    public function searchKelBenowo(Request $request)
    {
    ...
    if ($searchKeyword) {
        ...
        if ($data->isEmpty()) {
            return view('content.kelurahan.Kecamatan_28_Pakal.Kelurahan_Benowo.index')
                ->with('data', $data)
