...
class KotaSurabayaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Kota_Surabaya_Form::create($data);
        return redirect()->to('KotaSurabaya')->with('success','berhasil menambahkan data');
    }
    ...
    {
        $data = Kota_Surabaya_Form::where('tahapan',$id)->first();
        return view('content.kota.Kota_Surabaya.edit')->with('data', $data);
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        Kota_Surabaya_Form::where('tahapan',$id)->update($data);
        return redirect()->to('KotaSurabaya')->with('success','berhasil mengupdate data');
    }
