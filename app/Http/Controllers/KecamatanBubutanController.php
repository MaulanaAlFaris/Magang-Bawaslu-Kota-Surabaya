...
use App\Models\Kecamatan_Bubutan_Form;
...
class KecamatanBubutanController extends Controller
{
    /**
    ...
    {
        return view('content.kecamatan.Kecamatan_Bubutan.create');
    }
        ...
        {
            {
                ...
                return redirect()->to('KecamatanBubutan')->with('success','berhasil menambahkan data');
            }
        }
    }
    ...
    {
        $data = Kecamatan_Bubutan_Form::where('tahapan',$id)->first();
        return view('content.kecamatan.Kecamatan_Bubutan.edit')->with('data', $data);
    }
    ...
    {
        Kecamatan_Bubutan_Form::where('tahapan',$id)->delete();
        return redirect()->to('KecamatanBubutan')->with('succes','berhasil melakukan delete data');
    }
    ...
    if ($searchKeyword) {
        $data = Kecamatan_Bubutan_Form::where('nama_pelaksana', 'LIKE', "%$searchKeyword%")
