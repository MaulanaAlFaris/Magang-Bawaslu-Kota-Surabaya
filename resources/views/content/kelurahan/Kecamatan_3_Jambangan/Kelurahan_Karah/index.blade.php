...
<div class="container-name">
    <h1>Selamat Datang Di Kelurahan Karah</h1>
</div>
<div class="content-main-bg">
        <div class="my-3 p-3 bg-body rounded shadow-sm">
            <!-- TOMBOL TAMBAH DATA -->
            <div class="pb-3">
            <a href='{{ url('KelurahanKarah/create') }}' class="btn btn-primary">+ Tambah Data</a>

            <form action="{{ route('KelurahanKarah.search') }}" method="GET" class="form-inline mb-3">
