...
<div class="container-name">
    <h1>Selamat Datang Di Kelurahan Sidotopo Wetan</h1>
</div>
<div class="content-main-bg">
        <div class="my-3 p-3 bg-body rounded shadow-sm">
            <!-- TOMBOL TAMBAH DATA -->
            <div class="pb-3">
            <a href='{{ url('KelurahanSidotopoWetan/create') }}' class="btn btn-primary">+ Tambah Data</a>

            <form action="{{ route('KelurahanSidotopoWetan.search') }}" method="GET" class="form-inline mb-3">
