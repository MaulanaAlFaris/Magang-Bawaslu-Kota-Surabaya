...
<div class="container-name">
    <h1>Selamat Datang Di Kelurahan Gundih</h1>
</div>
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href='{{ url('KelurahanGundih/'.$item->tahapan.'/edit') }}' class="btn btn-warning btn-sm">Edit</a>
                            <a href='{{ url("KelurahanGundih/".$item->tahapan) }}' class="btn btn-success btn-sm">PDF</a>

                            <form onsubmit="return confirm('Yakin akan menghapus data?')" class='d-inline' action="{{ url('KelurahanGundih'.$item->tahapan) }}" method="post">
                                @csrf
                                @method('DELETE')
