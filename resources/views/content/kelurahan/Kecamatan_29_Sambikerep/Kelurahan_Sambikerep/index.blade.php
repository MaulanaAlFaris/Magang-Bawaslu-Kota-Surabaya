...
<div class="container-name">
    <h1>Selamat Datang Di Kelurahan Sambikerep</h1>
</div>
<div class="content-main-bg">
        <div class="my-3 p-3 bg-body rounded shadow-sm">
            ...
            <form action="{{ route('KelurahanSambikerep.search') }}" method="GET" class="form-inline mb-3">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href='{{ url("KelurahanSambikerep/".$item->tahapan) }}' class="btn btn-success btn-sm">PDF</a>
