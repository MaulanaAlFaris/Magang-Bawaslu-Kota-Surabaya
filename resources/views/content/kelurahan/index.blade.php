...
@section('content-main')
        <div class="my-3 p-3 bg-body rounded shadow-sm">
            <!-- TOMBOL TAMBAH DATA -->
            <div class="pb-3">
            <a href='{{ url('kelurahan/create') }}' class="btn btn-primary">+ Tambah Data</a>
            </div>
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $item->uraian }}</td>
                        <td>
                            <a href='{{ url('kelurahan/'.$item->tahapan.'/edit') }}' class="btn btn-warning btn-sm">Edit</a>
                            <form onsubmit="return confirm('Yakin akan menghapus data?')" class='d-inline' action="{{ url('kelurahan/'.$item->tahapan) }}" method="post">
                                @csrf
                                @method('DELETE')
