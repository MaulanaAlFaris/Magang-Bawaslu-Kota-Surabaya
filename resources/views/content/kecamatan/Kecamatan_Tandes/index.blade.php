...
<div class="container-name">
    <h1>Selamat Datang Di Kecamatan Tandes</h1>
</div>
<div class="content-main-bg">
        <div class="my-3 p-3 bg-body rounded shadow-sm">
            <!-- TOMBOL TAMBAH DATA -->
            <div class="pb-3">
            <a href='{{ url('KecamatanTandes/create') }}' class="btn btn-primary">+ Tambah Data</a>

            <form action="{{ route('KecamatanTandes.search') }}" method="GET" class="form-inline mb-3">
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href='{{ url('KecamatanTandes/'.$item->tahapan.'/edit') }}' class="btn btn-warning btn-sm">Edit</a>
                            <a href='{{ url('KecamatanTandes/'.$item->tahapan) }}' class="btn btn-success btn-sm">PDF</a>
                            <form onsubmit="return confirm('Yakin akan menghapus data?')" class='d-inline' action="{{ url('KecamatanTandes/'.$item->tahapan) }}" method="post">
                                @csrf
                                @method('DELETE')
