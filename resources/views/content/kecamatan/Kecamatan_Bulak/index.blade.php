...
<div class="content-main-bg">
        <div class="my-3 p-3 bg-body rounded shadow-sm">
            <!-- TOMBOL TAMBAH DATA -->
            <div class="pb-3">
            <a href='{{ url('KecamatanBulak/create') }}' class="btn btn-primary">+ Tambah Data</a>

            <form action="{{ route('KecamatanBulak.search') }}" method="GET" class="form-inline mb-3">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href='{{ url('KecamatanBulak/'.$item->tahapan) }}' class="btn btn-success btn-sm">PDF</a>
