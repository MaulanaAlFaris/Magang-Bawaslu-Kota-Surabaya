...
<div class="content-main-bg">
        <div class="my-3 p-3 bg-body rounded shadow-sm">
            ...
            <form action="{{ route('KecamatanGayungan.search') }}" method="GET" class="form-inline mb-3">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href='{{ url('KecamatanGayungan/'.$item->tahapan) }}' class="btn btn-success btn-sm">PDF</a>
