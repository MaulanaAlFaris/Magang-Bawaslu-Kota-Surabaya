...
<div class="container-name">
    <h1>Selamat Datang Di Kecamatan Gubeng</h1>
</div>
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href='{{ url('KecamatanGubeng/'.$item->tahapan.'/edit') }}' class="btn btn-warning btn-sm">Edit</a>
                            <a href='{{ url('KecamatanGubeng/'.$item->tahapan) }}' class="btn btn-success btn-sm">PDF</a>
                            <form onsubmit="return confirm('Yakin akan menghapus data?')" class='d-inline' action="{{ url('KecamatanGubeng/'.$item->tahapan) }}" method="post">
                                @csrf
                                @method('DELETE')
