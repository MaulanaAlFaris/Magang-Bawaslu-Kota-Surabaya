        ...
        <div class="main-content">
            <div class="main-content-background">
                ...
                <div class="homebarsec2" id="experience-id">
                    ...
                    <div class="homebarsec2-bg">
                        <div class="homebar2">
                            <li>
                                <div class="card-homebar2">
                                    <div class="logo-card-homebar2">
                                        <img src="{{ asset('images/uiux.png') }}" alt="#">
                                    </div>
                                    <h2>UI/UX Design</h2>
                                    <p>UI Design (User Interface Design) adalah cara produk digital terlihat. Ini mencakup warna, bentuk, tombol, dan semua yang Anda lihat saat menggunakan aplikasi atau situs web. Tujuannya adalah membuatnya terlihat bagus dan mudah dipahami.</p>
                                    <p>UX Design (User Experience Design) adalah tentang bagaimana produk digital berfungsi dan bagaimana pengguna berinteraksi dengannya. Ini mencakup apakah produknya mudah digunakan, membuat pengguna senang, dan memecahkan masalah pengguna dengan baik. Kedua desain ini sangat penting karena antarmuka yang baik (UI) dan pengalaman pengguna yang baik (UX) membuat produk digital lebih baik untuk digunakan oleh orang lain.</p>
                                </div>
                            </li>
                            ...
                            <li>
                                <div class="card-homebar2">
                                    ...
                                    <p>Web development adalah proses menciptakan dan memelihara situs web atau aplikasi web. Ini mencakup desain tampilan depan (UI) yang dilihat oleh pengguna dan pengembangan back-end yang mengatur bagaimana situs web berfungsi.</p>
                                    <p>Pengembang menggunakan bahasa pemrograman seperti HTML, CSS, JavaScript, dan bahasa back-end seperti PHP, Python, atau Ruby. Mereka juga mengelola basis data untuk menyimpan informasi. Pengujian dan optimisasi kinerja penting sebelum situs web diluncurkan. Keamanan juga menjadi fokus untuk melindungi data dan mencegah serangan. Setelah peluncuran, pemeliharaan berkala diperlukan untuk memastikan situs web tetap berjalan dengan baik dan aman. Tujuan utama adalah menciptakan situs web yang fungsional, menarik, dan responsif.</p>
                                </div>
                            </li>
                            ...
                            <li>
                                <div class="card-homebar2">
                                    ...
                                    <p>Application development adalah proses merancang, membangun, dan mengembangkan aplikasi perangkat lunak untuk berbagai platform seperti mobile, desktop, dan web. Ini melibatkan pemilihan bahasa pemrograman, pengembangan antarmuka pengguna (UI), logika aplikasi, dan pengujian.</p>
                                    <p>Pengembang aplikasi menciptakan solusi perangkat lunak yang memenuhi kebutuhan pengguna dengan fokus pada fungsionalitas, keamanan, dan kinerja. Mereka juga memelihara dan memperbarui aplikasi secara berkala untuk memastikan konsistensi dan keamanan. Tujuan utama adalah memberikan pengalaman yang efektif, efisien, dan memuaskan kepada pengguna melalui aplikasi yang dapat digunakan dengan mudah dan memecahkan masalah yang spesifik.</p>
                                </div>
                            </li>
                        </div>
                    </div>
                ...
                <div class="homebarsec3" id="portofolio-id">
                    ...
                    <div class="homebarsec3-bg">
                        <div class="homebar3">
                            <li>
                                <div class="card-homebar3">
                                    <div class="logo-card-homebar3">
                                        <img src="{{ asset('images/totty-porto.png') }}" alt="FOTO-Porto">
                                    </div>
